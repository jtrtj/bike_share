...
describe 'An admin' do
  describe 'visiting the dashboard' do
    ...
    it 'can see all accessories in a table on admin/bike-shop with a thumbnail of the image, description, status, ability to edit accessory and ability to Retire/Reactivate accessory' do
