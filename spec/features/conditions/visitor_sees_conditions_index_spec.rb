...
describe 'A visitor' do
  context 'visits conditions index' do
    it 'sees all conditions with Date, Max Temperature, Mean Temperature, Min Temperature, Mean Humidity, Mean Visibility (in Miles), Mean Wind Speed (mph), Precipitation (inches)' do
      condition_1 = Condition.create!(date: Time.now, max_temperature_f: 90.0, mean_temperature_f: 80.0, min_temperature_f: 70.0, mean_humidity: 60.0, mean_visibility_miles: 70.0, mean_wind_speed_mph: 30.0, precipitation_inches: 25.0, zip_code: 11)
      condition_2 = Condition.create(date: Time.now, max_temperature_f: 80.0, mean_temperature_f: 70.0, min_temperature_f: 60.0, mean_humidity: 60.0, mean_visibility_miles: 30.0, mean_wind_speed_mph: 20.0, precipitation_inches: 2.0, zip_code: 11)
      ...
      expect(page).to have_content(condition_2.zip_code)
    end
  end
end
